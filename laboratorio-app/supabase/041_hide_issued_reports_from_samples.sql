-- Las muestras con informe emitido dejan de formar parte del tablero operativo.
...
begin
  ...
  where ao.status not in ('cancelada', 'informe_emitido')
    and ao.report_number is null
